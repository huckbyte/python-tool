class  Schoool_Library:
    ...
    def Borrow(self,user_name,book_name):
        if book_name not in self.borrow.keys():
            ...
            print(f"The book has been added in the database. You can now borrow the book.")
        else:
            print(f"Sorry {self.borrow[book_name]} has been already been borrowed by {self.name}.Please choose another book !")
...
if __name__ == '__main__':
    ...
    obj = Schoool_Library([ 'JAVASCRIPT', 'C & C++', 'MEDIAPIPE', "PYTHON",'NODE JS', 'HTMl & CSS'], 'MICHEAL SAMI')
    obj.User_Choice()