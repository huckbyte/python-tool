...
class Window:
    def __init__(self, master):
        ...
        self.notebook = ttk.Notebook(self.master,width=400,height=400)
        ...
        txt = tk.Text(frame1,bg="red")
        # txt.pack(side="bottom")
        btn = ttk.Button(frame1,text="click",command=quit)
        btn.pack(side="left")
        label4 = tk.Label(frame1,text="welcom")
        ...
        self.notebook.add(frame5, text = "Window 3")
...
#         # self.tab1_image = tk.PhotoImage(file = "closeIcon.png")
 
#         self.notebook.add(frame1, text = "Window 1", 
#                           compound = "left", padding = [10, 0, 10, 0])  # type: ignore
#         self.notebook.add(frame2, text = "Window 2")
#         self.notebook.add(frame3, text = "Window 3")
